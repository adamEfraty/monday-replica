        ...
        <div className="task-card">
            ...
            <div className="task-card-flex">
                <div className="grid-item status">
                    <Status cellInfo={task.cells[1]} onTaskUpdate={onTaskUpdate} labelWidth={400} />
                </div>
                <div className=" grid-item priority">
                    <Priority cellInfo={task.cells[2]} onTaskUpdate={onTaskUpdate} labelWidth={400} />
                </div>
                <div className="grid-item members">
                    <Members cellInfo={task.cells[3]} users={users} onTaskUpdate={onTaskUpdate} labelWidth={400} />
                </div>
                <div className="grid-item date">
                    <Date cellInfo={task.cells[4]} onTaskUpdate={onTaskUpdate} labelWidth={400} />
                </div>
            </div>
        </div>
    );
